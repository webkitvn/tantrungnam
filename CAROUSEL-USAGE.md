...
The carousel includes comprehensive CSS styles. You can customize the appearance by overriding the default styles:
...
The carousel is fully responsive and includes mobile-optimized styles:
...
Enable debug logging by opening the browser console. The carousel will log initialization status and any errors.
...
<div class="block-carousel auto-play loop">
  <div class="kt-row-column-wrap">
    <div class="wp-block-kadence-column">
      ...
      <p>This carousel has autoplay and loop enabled via CSS classes.</p>
    </div>
    <div class="wp-block-kadence-column">
...
```html
<!-- 3 items per slide on desktop, 2 on mobile -->
<div class="block-carousel carousel-3-items carousel-sm-2-items">
  <div class="kt-row-column-wrap">
